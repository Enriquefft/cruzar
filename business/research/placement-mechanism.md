...
`View:` autonomous application removes the dependency on US job board partnerships. The company could start placing students immediately without needing to build a partner network first. The actual go/no-go decision lives in [product/cruzar/](../../product/cruzar/) or [company/](../../company/), not here.
