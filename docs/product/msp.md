...
#### B1. Domain + Email
- Register cruzar.io ($38/yr)
- Configure email: hello@cruzar.io
...
5. Founding partner proposal with pricing ($8K anchor + up to $12K outcomes, $20K max, 12-week pilot, 40 students) (5 min)
...
**Pricing preview (for Phase 2 materials):**
- $8K anchor fee on signature (non-refundable; covers setup + first 4 weeks)
- Up to $12K outcomes fee across 3 milestones ($4K each): 60% readiness conversion in 8 weeks, 20 students in interview processes, 6 formal offers within pilot + 30 days
- Max $20K, min $8K
- Fallback if no budget: zero anchor in exchange for cohort access + signed LOI for full deployment if pilot succeeds
- Founding partner: 36-month price lock, co-marketing rights, first in LatAm
...
| Email | cruzar.io domain email | Professional from day 1 |
...
| University | Begin conversations. Point to cruzar.io. Show dashboard with live data. |
...
### Phase 1
- [ ] cruzar.io live with landing page
...
- [ ] University conversations started with cruzar.io as reference
...
| "Aprendly Bridge" product line | Cruzar as independent spinoff |
