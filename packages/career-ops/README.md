...
Multi-tenant critical-path subset of the job-application pipeline absorbed from `~/Projects/jobs/` per [ADR-03](../../product/cruzar/adr/03-career-ops-absorb-scope.md). Driven by `scripts/run-cohort.ts` — not invoked standalone.
